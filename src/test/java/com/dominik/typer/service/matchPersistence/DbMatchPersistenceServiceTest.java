...
class DbMatchPersistenceServiceTest implements ProvideMatch {
    @Mock
    ...
    @Test
    public void givenAdminUserAndMatch_whenSaveWithAdmin_thenReturnCheckIfSaved() {
        //given
    ...
    @Test
    public void givenNotAdminUserAndMatch_whenSaveWithAdmin_thenDoNothing() {
        //given
        Match match = provideMatch();
    ...
    @Test
    public void givenListOfMatches_whenGetAllMatches_thenReturnListOfMatches() {
        //given
    ...
    @Test
    public void givenListOfMatches_whenGetAllMatchesPossibleToBet_thenReturnListOfMatches() {
        //given
        List<Match> matchesWithFutureDate = provide20MatchesWithDateInFuture();
